...
export default function SearchBar({ setSearchQuery, searchQuery }: any) {
  return (
    <form className="border-[1px] gap-x-1 flex items-center overflow-hidden rounded-2xl px-2 py-1 w-full">
      ...
      <input
        ...
        className="w-[90%] outline-none p-1 text-sm placeholder:text-[#7a7a7a]"
        spellCheck={false}
      />
    </form>
  );
