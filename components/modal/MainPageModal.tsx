        ...
        <div className="font-semibold text-base text-slate-700 flex gap-x-2 items-center">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M2.5 8.33331C2.5 4.19118 5.85786 0.833313 10 0.833313C14.1421 0.833313 17.5 4.19118 17.5 8.33331C17.5 11.3987 15.7828 13.0718 14.1814 14.415C14.0121 14.557 13.8461 14.6944 13.684 14.8285C12.2504 16.0152 11.1276 16.9446 10.8172 18.4967C10.7392 18.8863 10.3972 19.1666 10 19.1666C9.60277 19.1666 9.26075 18.8863 9.18285 18.4967C8.87242 16.9446 7.74956 16.0152 6.31596 14.8285C6.15391 14.6944 5.98789 14.557 5.81863 14.415C4.21724 13.0718 2.5 11.3987 2.5 8.33331ZM12.5 8.33331C12.5 9.71403 11.3807 10.8333 10 10.8333C8.61929 10.8333 7.5 9.71403 7.5 8.33331C7.5 6.9526 8.61929 5.83331 10 5.83331C11.3807 5.83331 12.5 6.9526 12.5 8.33331Z"
              fill="#333333"
            />
          </svg>
