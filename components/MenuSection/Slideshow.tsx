...
export default function Slideshow({ closeModal, currentImageIndex, setCurrentImageIndex, image }: any) {
  ...
  return (
    <Backdrop onClick={closeModal}>
      ...
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 absolute top-6 right-6 z-50" onClick={closeModal}>
      ...
      <div className="absolute inset-x-8 inset-y-[150px] ">
          <Image src={image[currentImageIndex]} alt="resto" objectFit="contain" className="rounded-md" width={336} height={400} />
       </div>
        <div className=" absolute inset-x-0 bottom-0 flex gap-x-4 overflow-x-scroll">
