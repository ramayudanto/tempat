              ...
              <div className="p-4 space-y-1">
                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex items-center gap-x-1  py-1 px-2 rounded-md">
                    <svg width="12" height="12" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" className="mb-[1px] fill-orange-600">
                      <path
                    ...
                    <p className="text-xs text-slate-700 font-semibold">{(restaurant.ratingSum / restaurant.ratingCount).toFixed(1)}</p>
