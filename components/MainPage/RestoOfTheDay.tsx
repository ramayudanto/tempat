...
const demie = {
  ...
  delivery: true,
  dine_in: true,
  formatted_address: "1, Como Park, Jl. Kemang Timur No.998, RT.4/RW.3, Bangka, Kec. Mampang Prpt., Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12730, Indonesia",
  ...
  takeout: true,
  thumbnail: "https://tempatapp.sgp1.cdn.digitaloceanspaces.com/Menu/Demie-Kemang/demie-kemang4.jpg",
  ...
  categories: [
    {
      ...
      header: "https://tempatapp.sgp1.digitaloceanspaces.com/category/Noodles-highres.jpg",
      description: "Mie favorit ada di sini! Pilih variasi mie favoritmu dan nikmati sensasi kelezatan yang tak terlupakan.",
    },
  ],
  opening_hours: {
    id: 213,
...
export default function RestoOfTheDay() {
  ...
  return (
    <Link href={`/restos/${demie.place_id}`}>
      ...
      >
        <div className="bg-cover bg-center h-[135px] relative rounded-t-lg" style={{ backgroundImage: `url(${demie.thumbnail})` }}>
        ...
        <div className="p-3 space-y-2 bg-[#F2F4F7] overflow-hidden rounded-b-lg">
          ...
          <div className="flex justify-between">
            <p className="font-bold text-darkGray text-xs">{truncate(demie.gofood_name, 36)}</p>
            {/* <p className="font-semibold text-darkGray text-xs">Mie Gacoan, Jakarta Cakung Garden City abcd abcd</p> */}
            <div className="flex items-center gap-x-[2px]">
              ...
              <p className="text-xs text-green">{demie.rating}</p>
            </div>
          </div>
          <div className="flex justify-between">
            ...
            <p className=" text-darkGray text-opacity-70 text-xs">{translatePriceRange(demie.price_level)}</p>
          </div>
