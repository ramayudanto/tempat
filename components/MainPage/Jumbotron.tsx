...
export default function Jumbotron() {
  return (
    <div className="relative">
      ...
      <div className="border-[1px] w-3/4 bg-white flex justify-between items-center overflow-hidden mx-auto left-0 right-0 my-4 rounded-lg px-2 py-1 absolute -bottom-[20%]">
        <button>
